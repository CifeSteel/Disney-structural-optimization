...
Module Module1
    Sub Main()
        ...
        Dim Member_I_U1 = New List(Of String)
        Dim Member_I_U2 = New List(Of String)
        Dim Member_I_U3 = New List(Of String)
        Dim Member_I_R1 = New List(Of String)
        Dim Member_I_R2 = New List(Of String)
        Dim Member_I_R3 = New List(Of String)
        Dim Member_J_U1 = New List(Of String)
        Dim Member_J_U2 = New List(Of String)
        Dim Member_J_U3 = New List(Of String)
        Dim Member_J_R1 = New List(Of String)
        Dim Member_J_R2 = New List(Of String)
        Dim Member_J_R3 = New List(Of String)
        Dim Member_AddBack = New List(Of String)
        ...
        Do Until readstreammember.EndOfStream
            ...
            Member_I_U1.Add(Convert.ToString(memberdata(4)))
            Member_I_U2.Add(Convert.ToString(memberdata(5)))
            Member_I_U3.Add(Convert.ToString(memberdata(6)))
            Member_I_R1.Add(Convert.ToString(memberdata(7)))
            Member_I_R2.Add(Convert.ToString(memberdata(8)))
            Member_I_R3.Add(Convert.ToString(memberdata(9)))
            Member_J_U1.Add(Convert.ToString(memberdata(10)))
            Member_J_U2.Add(Convert.ToString(memberdata(11)))
            Member_J_U3.Add(Convert.ToString(memberdata(12)))
            Member_J_R1.Add(Convert.ToString(memberdata(13)))
            Member_J_R2.Add(Convert.ToString(memberdata(14)))
            Member_J_R3.Add(Convert.ToString(memberdata(15)))
            Member_AddBack.Add(Convert.ToString(memberdata(16)))
        Loop
