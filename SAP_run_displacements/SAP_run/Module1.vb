...
Module Module1
    Sub Main()
        ...
        SM.File.OpenFile(AppPath + "\SAPMODEL\AI_ROCKWORK_Simplified.sdb")
        ...
        SM.File.Save(AppPath + "\SAPMODEL\AI_ROCKWORK_Simplified.sdb")
        ...
        SM.File.Save(AppPath + "\SAPMODEL\AI_ROCKWORK_Simplified_" + time + ".sdb")
