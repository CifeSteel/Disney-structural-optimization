...
numberToRemove = int(np.ceil(inputs.get_value(2, "Values") * len(bracesIDs) / 100.0))

if numberToRemove % 2 != 0:
	numberToRemove += 1

membersRemoved = braces[:numberToRemove]
membersRemaining = braces[numberToRemove:]
